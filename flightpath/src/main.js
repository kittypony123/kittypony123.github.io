...
if (isMobileDevice()) {
  ...
  // Reduce devicePixelRatio on very high-DPI mobile devices for performance
  const originalDPR = window.devicePixelRatio || 1;
  if (originalDPR > 2) {
    // Cap DPR at 2 for mobile devices to maintain 60fps
    Object.defineProperty(window, 'devicePixelRatio', {
      get: function() { return Math.min(originalDPR, 2); },
      configurable: false
    });
  }
}
