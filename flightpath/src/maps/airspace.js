...
export const AIRSPACE_CONFIG = {
  ...
  lineColors: [
    '#FFB347', // 0: Peach/Gold - EXPRESS routes to final destinations (highest priority, +40% speed)
    '#40E0D0', // 1: Turquoise - HUB-to-HUB connections (fast transfer routes, +20% speed)
    '#87CEEB', // 2: Sky Blue - REGIONAL hub feeders (standard speed, good connectivity)
    '#FF6B6B', // 3: Coral Red - RELIEF regional routes (slower local connections, -10% speed)
    '#DDA0DD', // 4: Plum - Specialty/overflow routes
    '#98FB98', // 5: Pale Green - Growth expansion routes
    '#FFB6C1'  // 6: Light Pink - Backup/additional routes
  ],
